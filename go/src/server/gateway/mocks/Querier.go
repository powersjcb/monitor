...
// GetMetricStatsPerPeriod provides a mock function with given fields: ctx, arg
func (_m *Querier) GetMetricStatsPerPeriod(ctx context.Context, arg db.GetMetricStatsPerPeriodParams) ([]db.GetMetricStatsPerPeriodRow, error) {
	ret := _m.Called(ctx, arg)

	var r0 []db.GetMetricStatsPerPeriodRow
	if rf, ok := ret.Get(0).(func(context.Context, db.GetMetricStatsPerPeriodParams) []db.GetMetricStatsPerPeriodRow); ok {
		r0 = rf(ctx, arg)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, db.GetMetricStatsPerPeriodParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
